      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-serif">AGENCY 414</h2>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-serif mb-6">Get in Touch</h3>
            <ul className="space-y-4 text-white/60">
              <li>
                <a href="mailto:hello@agency414.com" className="hover:text-white transition-colors duration-300">
                  hello@agency414.com
                </a>
              </li>
              <li>
