  ...
  return (
    <section className="relative py-24 bg-black">
      ...
      <div className="container mx-auto px-4 mb-12 relative">
        <h2 className="text-5xl md:text-7xl font-serif italic text-center gradient-text">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="glass-effect p-12 rounded-lg hover-scale">
            <h3 className="text-3xl font-serif text-white mb-2">ELEVATE YOUR BRAND</h3>
            <h4 className="text-4xl font-script text-white mb-8 gradient-text">Get in touch</h4>
            <button className="bg-white text-black px-8 py-3 rounded hover:bg-gray-200 transition-colors">
              BOOK A CALL
            </button>
